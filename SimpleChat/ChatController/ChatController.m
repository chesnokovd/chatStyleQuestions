...
- (void)viewDidLoad
{
    ...
    _chatInput.placeholderLabel.text = @"  Tap to answer";
    ...
    int topOffset = 10;
        ...
        CGFloat topInset = CGRectGetHeight(navBarFrame) + CGRectGetMinY(navBarFrame) + topOffset;
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!message[kMessageSize]) {
        ...
        int maxTextLabelWidth = maxBubbleWidth;
        ...
        return CGSizeMake(width(_myCollectionView), rect.size.height + offset*2);
    }
    else {
